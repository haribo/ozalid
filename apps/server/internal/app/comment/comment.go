...
type Repository interface {
	Track(ctx context.Context, commentID, actorID string, issue IssueRef) (Outcome, error)
	Discard(ctx context.Context, commentID, actorID, reason string) (Outcome, error)
	Deliver(ctx context.Context, commentID, actorID string) (Outcome, error)
	Judge(ctx context.Context, commentID, actorID string, accept bool, remark string) (Outcome, error)
...
func (s *Service) Track(ctx context.Context, commentID, actorID string, issue IssueRef) (Outcome, error) {
	...
	return s.repo.Track(ctx, commentID, actorID, issue)
}
...
func (s *Service) Discard(ctx context.Context, commentID, actorID, reason string) (Outcome, error) {
	return s.repo.Discard(ctx, commentID, actorID, strings.TrimSpace(reason))
}
...
func (s *Service) Deliver(ctx context.Context, commentID, actorID string) (Outcome, error) {
	return s.repo.Deliver(ctx, commentID, actorID)
}

// Judge accepts a delivery, or refuses it with a remark.
func (s *Service) Judge(ctx context.Context, commentID, actorID string, accept bool, remark string) (Outcome, error) {
	return s.repo.Judge(ctx, commentID, actorID, accept, strings.TrimSpace(remark))
}
